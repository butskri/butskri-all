...
public class MatchComparators {
    ...
    static <T extends AggregateEvent> MatchComparator<T> instancesOfSameType() {
    ...
    private static boolean havingSameValuesForFields(AggregateEvent value, AggregateEvent otherValue, String... fields) {
